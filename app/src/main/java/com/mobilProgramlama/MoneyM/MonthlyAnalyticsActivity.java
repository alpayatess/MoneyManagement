package com.mobilProgramlama.MoneyM;
...
public class MonthlyAnalyticsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Aylık Analiz");
...
//imageviews
    ...
    private void getTotalWeekTransportExpense() {
        ...
        String itemNmonth = "Ulaşım"+months.getMonths();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        totalAmount += pTotal;
                        analyticsTransportAmount.setText("Harcama: " + totalAmount);
                    }
    ...
    private void getTotalMonthsFoodExpense(){
        ...
        String itemNmonth = "Yemek"+months.getMonths();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsFoodAmount.setText("Harcama: " + totalAmount);
                    }
    ...
    private void getTotalMonthsHouseExpense(){
        ...
        String itemNmonth = "Ev Giderleri"+months.getMonths();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsHouseExpensesAmount.setText("Harcama: " + totalAmount);
                    }
    ...
    private void getTotalMonthEntertainmentExpenses(){
        ...
        String itemNmonth = "Eğlence"+months.getMonths();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsEntertainmentAmount.setText("Harcama: " + totalAmount);
                    }
    ...
    private void getTotalWeekEducationExpenses(){
        ...
        String itemNmonth = "Eğitim"+months.getMonths();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsEducationAmount.setText("Harcama: " + totalAmount);
                    }
    ...
    private void getTotalWeekCharityExpenses(){
        ...
        String itemNmonth = "Bağış"+months.getMonths();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsCharityAmount.setText("Harcama: " + totalAmount);
                    }
    ...
    private void getTotalWeekApparelExpenses(){
        ...
        String itemNmonth = "Giyim-Kuşam"+months.getMonths();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsApparelAmount.setText("Harcama: " + totalAmount);
                    }
    ...
    private void getTotalWeekHealthExpenses(){
        ...
        String itemNmonth = "Sağlık"+months.getMonths();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsHealthAmount.setText("Harcama: " + totalAmount);
                    }
    ...
    private void getTotalWeekPersonalExpenses(){
        ...
        String itemNmonth = "Kişisel Harcama"+months.getMonths();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsPersonalExpensesAmount.setText("Harcama: " + totalAmount);
                    }
    ...
    private void getTotalWeekOtherExpenses(){
        ...
        String itemNmonth = "Diğer"+months.getMonths();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsOtherAmount.setText("Harcama: " + totalAmount);
                    }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                    ...
                    totalBudgetAmountTextView.setText("Aylık Harcama: "+ totalAmount + "TL");
                    monthSpentAmount.setText("Toplam Harcama: "+totalAmount + "TL");
                }else {
        ...
        personalRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if (monthPercent<50){
                        monthRatioSpending.setText(monthPercent+" %" +" kullanım "+monthTotalSpentAmountRatio + ". Durum:");
                    ...
                    if (transportPercent<50){
                        progress_ratio_transport.setText(transportPercent+" %" +" kullanım "+traRatio + ". Durum:");
                    ...
                    if (foodPercent<50){
                        progress_ratio_food.setText(foodPercent+" %" +" kullanım "+foodRatio + ". Durum:");
                    ...
                    if (housePercent<50){
                        progress_ratio_house.setText(housePercent+" %" +" kullanım "+houseRatio + ". Durum:");
                    ...
                    if (entPercent<50){
                        progress_ratio_ent.setText(entPercent+" %" +" kullanım "+entRatio + ". Durum:");
                    ...
                    if (eduPercent<50){
                        progress_ratio_edu.setText(eduPercent+" %" +" kullanım "+eduRatio + ". Durum:");
                    ...
                    if (chaPercent<50){
                        progress_ratio_cha.setText(chaPercent+" %" +" kullanım "+chaRatio + ". Durum:");
                    ...
                    if (appPercent<50){
                        progress_ratio_app.setText(appPercent+" %" +" kullanım "+appRatio + ". Durum:");
                    ...
                    if (heaPercent<50){
                        progress_ratio_hea.setText(heaPercent+" %" +" kullanım "+heaRatio + ". Durum:");
                    ...
                    if (perPercent<50){
                        progress_ratio_per.setText(perPercent+" %" +" kullanım "+perRatio + " . Durum:");
                    ...
                    if (otherPercent<50){
                        progress_ratio_oth.setText(otherPercent+" %" +" kullanım "+othRatio + ". Durum:");
