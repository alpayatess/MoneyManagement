...
public class DailyAnalyticsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Bugünün Analizi");
...
//imageviews
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        totalAmount += pTotal;
                        analyticsTransportAmount.setText("Harcama: " + totalAmount + "TL");
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsFoodAmount.setText("Harcama: " + totalAmount + "TL");
                    }
    ...
    private void getTotalWeekHouseExpenses(){
        ...
        Calendar cal = Calendar.getInstance();
        String date = dateFormat.format(cal.getTime());
        String itemNday = "Ev Giderleri"+date;
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsHouseExpensesAmount.setText("Harcama: " + totalAmount + "TL");
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsEntertainmentAmount.setText("Harcama: " + totalAmount +"TL");
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsEducationAmount.setText("Harcama: " + totalAmount + "TL");
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsCharityAmount.setText("Harcama: " + totalAmount + "TL");
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsApparelAmount.setText("Harcama: " + totalAmount +"TL");
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsHealthAmount.setText("Harcama: " + totalAmount + "TL");
                    }
    ...
    private void getTotalWeekPersonalExpenses(){
        ...
        Calendar cal = Calendar.getInstance();
        String date = dateFormat.format(cal.getTime());
        String itemNday = "Kişisel Harcamalar"+date;
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsPersonalExpensesAmount.setText("Harcama: " + totalAmount + "TL");
                    }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    for (DataSnapshot ds :  snapshot.getChildren()) {
                        ...
                        int pTotal = Integer.parseInt(String.valueOf(total));
                        totalAmount += pTotal;
                        analyticsOtherAmount.setText("Harcama: " + totalAmount + "TL");
                    }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount()>0){
                    ...
                    totalBudgetAmountTextView.setText("Toplam Günlük Harcama: "+ totalAmount+ "TL");
                    monthSpentAmount.setText("Total Spent: $ "+totalAmount);
                }
                else {
                    totalBudgetAmountTextView.setText("Bugün harcama yapmadın");
