        ...
        budgetRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
             ...
             for (DataSnapshot snap: snapshot.getChildren()){
                 ...
                 String sTotal = String.valueOf("Aylık Bütçe: "+ totalAmount+ "TL");
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() && snapshot.getChildrenCount()>0){
                    ...
                    for (DataSnapshot snap:snapshot.getChildren()){
                        ...
                        String sttotal=String.valueOf("Aylık Bütçe: "+ totalammount + "TL");
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(budgetAmount)){
                    amount.setError("Miktar Gereklidir!");
                    return;
                }

                if (budgtItem.equals("Select item")){
                    Toast.makeText(BudgetActivity.this, "Geçerli bir kategori seçiniz", Toast.LENGTH_SHORT).show();
                }

                else {
                    loader.setMessage("Harcama ekleniyor");
                    ...
                    budgetRef.child(id).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                          if (task.isSuccessful()){
                              Toast.makeText(BudgetActivity.this, "Harcama başarıyla kaydedildi!", Toast.LENGTH_SHORT).show();
                          }else {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                budgetRef.child(post_key).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(BudgetActivity.this, "Başarıyla güncellendi!", Toast.LENGTH_SHORT).show();
                        }else {
                            Toast.makeText(BudgetActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                        }
        ...
        delBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                budgetRef.child(post_key).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(BudgetActivity.this, "Başarıyla", Toast.LENGTH_SHORT).show();
                        }else {
                            Toast.makeText(BudgetActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                        }
